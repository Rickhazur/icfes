...
interface TestingCenterProps {
  isOpen: boolean;
  onClose: () => void;
  onSimulatePersona: (name: string, role: 'STUDENT' | 'ADMIN', level: UserLevel) => void;
        ...
        <div className="p-6 space-y-8 max-h-[80vh] overflow-y-auto">
          ...
          <div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
              ...
              <button
                onClick={() => onSimulatePersona('Leo', 'STUDENT', 'primary')}
              ...
              <button
                onClick={() => onSimulatePersona('Director Rick', 'ADMIN', 'admin')}
