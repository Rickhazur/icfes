...
import { User, Bell, Lock, Shield, Moon, Volume2, Save, LogOut, Smartphone, Mail, AlertTriangle, RefreshCw, CheckCircle2, Globe, Baby } from 'lucide-react';
    ...
    <div className="max-w-4xl mx-auto space-y-8 animate-fade-in pb-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="md:col-span-2 space-y-8">
                ...
                {/* AGE SETTINGS (for primary students) */}
                {isPrimary && onAgeChange && (
                    <section className="bg-white p-6 rounded-2xl shadow-sm border border-stone-200">
                        <h3 className="text-lg font-bold text-stone-800 mb-6 flex items-center gap-2">
                            <Baby className="w-5 h-5 text-pink-500" /> 
                            {language === 'es' ? 'Edad del Estudiante' : 'Student Age'}
                        </h3>
                        <div className="space-y-4">
                            <p className="text-stone-600 text-sm">
                                {language === 'es' 
                                    ? 'Selecciona la edad para adaptar la voz y el contenido de Nova.'
                                    : 'Select age to adapt Nova\'s voice and content.'}
                            </p>
                                ...
                                {[6, 7, 8, 9, 10, 11].map((age) => (
                                    <button
                                        ...
                                        className={`w-16 h-16 rounded-xl font-black text-xl transition-all ${
                                            studentAge === age
                                                ? 'bg-gradient-to-r from-purple-500 to-pink-500 text-white scale-110 shadow-lg ring-4 ring-purple-300'
                            ...
                            <div className="bg-purple-50 border-2 border-purple-100 rounded-xl p-4">
                                <p className="text-purple-700 font-bold text-sm">
                                    {language === 'es' 
                                        ? `✨ Edad seleccionada: ${studentAge} años - Nova adaptará su forma de enseñar.`
                                        : `✨ Selected age: ${studentAge} years - Nova will adapt her teaching style.`}
                                </p>
                            </div>
                        </div>
                    </section>
